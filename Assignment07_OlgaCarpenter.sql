--*************************************************************************--
-- Title: Assignment07
-- Author: OlgaCarpenter
-- Desc: This file demonstrates how to use Functions
-- Change Log: When,Who,What
-- 2017-01-01,OlgaCarpenter,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_OlgaCarpenter')
	 Begin 
	  Alter Database [Assignment07DB_OlgaCarpenter] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_OlgaCarpenter;
	 End
	Create Database Assignment07DB_OlgaCarpenter;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_OlgaCarpenter;
...
Select
	ProductName, Format(UnitPrice, 'C', 'en-US') As 'US Format' 
	From vProducts
...
Select
	 c.CategoryName
	,p.ProductName
	,Format(p.UnitPrice,'C','en-US') As 'US Format'
